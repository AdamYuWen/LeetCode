 ...
 *	of the input array.
 * Update (2017-09-26):
 *	We have overhauled the problem description + test cases and specified clearly the graph
 *	is an undirected graph. For the directed graph follow up please see Redundant Connection
 *	II). We apologize for any inconvenience caused.
 * https://leetcode.com/problems/redundant-connection/description/
 * Reference: http://www.cnblogs.com/grandyang/p/7628977.html
 *
 * Author: Adam Yu Wen
 * Date: April 18, 2018
 */
...
public:
	...
	int find(vector<int> &root, int endVal) {
		while (root[endVal] != -1) {
			endVal = root[endVal];
		}
		return endVal;
